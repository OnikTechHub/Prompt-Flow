...
Prompt-Flow enables creators, marketers, developers, and writers to easily design, refine, organize, and share templates for AI prompt engineering with rich visual analytics, historical tracking, and community collaboration.
...
```env
PORT=5000
MONGO_URI=mongodb://localhost:27017/prompt-flow
