  ...
  const testimonials = [
    {
      ...
      text: "Prompt-Flow transformed our content operation overnight. We went from writing 3 blog posts a week to publishing daily high-quality newsletters and articles. Our SEO traffic is up 140% in just two months.",
      rating: 5,
    ...
    },
    {
      ...
      text: "I was skeptical about AI writing tools, but Prompt-Flow is in a different league. The FastAPI and Markdown exports integrate directly into my workflow. It generates actual structured layouts instead of unstructured paragraphs.",
      rating: 5,
      className: "md:col-span-1"
    },
    {
      ...
      featured: true,
      text: "We replaced three separate writing assistants with Prompt-Flow and saved over $1,200 monthly. The multi-model routing automatically swaps to Claude 3.5 for deep thinking tasks and GPT-4o for marketing copies. It is truly the ultimate production dashboard for content creation.",
      rating: 5,
      className: "md:col-span-2 border-cyan-500/40 bg-gradient-to-tr from-purple-950/20 via-indigo-950/20 to-pink-950/10 shadow-lg shadow-cyan-500/5"
    },
    {
      name: "Devon Reynolds",
      role: "SaaS Developer",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-base text-slate-400">
            Hear from SaaS founders, copywriters, and developers who have integrated Prompt-Flow into their daily production workflows.
          </p>
        </div>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    ...
                    {test.featured && (
                      <span className="inline-flex items-center gap-0.5 px-1.5 py-0.2 rounded bg-teal-500/20 text-cyan-300 border border-cyan-500/30 text-[9px] font-bold uppercase tracking-wider">
