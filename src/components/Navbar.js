      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={(e) => handleLinkClick(e, "home")}>
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-teal-500 via-cyan-500 to-emerald-500 shadow-md shadow-cyan-500/20">
              <Sparkles className="h-5 w-5 text-white animate-pulse" />
            </div>
            <span className="text-xl font-bold tracking-tight text-white">
              Prompt-Flow<span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-400">AI</span>
            </span>
          </div>
            ...
            {!isAuthenticated ? (
              ...
              <>
                <a 
                  ...
                  className={`text-sm font-semibold transition-colors ${
                    activeSection === "home" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
                  Home
                </a>
                <a 
                  ...
                  className={`text-sm font-semibold transition-colors ${
                    activeSection === "explore" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
                  Explore
                </a>
              ...
              <>
                ...
                <a 
                  ...
                  className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${
                    activeSection === "dashboard" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
                ...
                <a 
                  ...
                  className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${
                    activeSection === "workspace" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
                ...
                <a 
                  ...
                  className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${
                    activeSection === "history" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
                ...
                <a 
                  ...
                  className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${
                    activeSection === "profile" ? "text-cyan-400" : "text-slate-300 hover:text-white"
                  }`}
                >
            ...
            {!isAuthenticated ? (
              <>
                ...
                <button 
                  ...
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 text-sm font-bold text-white hover:shadow-lg hover:shadow-cyan-500/25 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                >
                  Register
                </button>
              </>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  <button 
                    ...
                    className="flex items-center gap-2 p-1 rounded-full border border-white/10 bg-white/5 hover:border-cyan-500/50 hover:bg-white/10 transition-all cursor-pointer"
                  >
                    <img 
                  ...
                  {isProfileDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-2xl border border-white/10 bg-[#0c0824] p-2 text-slate-200 shadow-xl shadow-black/80 ring-1 ring-black/5 focus:outline-none">
                      <div className="px-3 py-2.5 border-b border-white/5 mb-1.5">
                        ...
                        <p className="text-sm font-semibold truncate text-white">{user?.email || "alex.morgan@prompt-flow.ai"}</p>
                      </div>
                      <button 
              ...
              <>
                ...
                <div className="flex flex-col gap-2 pt-2">
                  ...
                  <button 
                    ...
                    className="w-full py-2.5 text-center text-sm font-semibold text-white bg-gradient-to-r from-teal-600 to-cyan-500 rounded-xl hover:shadow-lg hover:shadow-cyan-500/25 transition-all cursor-pointer"
                  >
                    Register
                  </button>
                </div>
              ...
              <>
                ...
                <div className="flex items-center gap-3 py-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">{user?.email || "alex.morgan@prompt-flow.ai"}</p>
                  </div>
                </div>
