...
export default function CTA({ onLogin }) {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] sm:h-[800px] sm:w-[800px] rounded-full bg-gradient-to-tr from-blue-600/10 via-cyan-600/10 to-pink-600/5 blur-[120px] pointer-events-none" />
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-gradient-to-br from-indigo-950/40 via-purple-950/20 to-[#030014]/60 p-8 sm:p-12 md:p-16 text-center shadow-2xl shadow-purple-900/10">
          ...
          {/* Icon Badge */}
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-teal-600 to-cyan-500 text-white shadow-lg shadow-cyan-500/20">
          ...
          {!submitted ? (
            ...
            <form onSubmit={handleSubmit} className="mt-10 max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-3 p-1.5 rounded-2xl bg-black/60 border border-white/10 focus-within:border-cyan-500/50 transition-all duration-300">
                <input
                  type="email"
                  value={email}
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 text-white text-sm font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transition-all cursor-pointer whitespace-nowrap"
                >
