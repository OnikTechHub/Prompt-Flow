...
export default function Statistics() {
    ...
    },
    {
      ...
      visual: (
        <div className="mt-4 space-y-2">
          ...
          <div>
            <div className="flex justify-between text-[10px] text-cyan-400 font-semibold mb-1">
              <span>PROMPT-FLOW ENGINE</span>
              <span>12 Min</span>
            </div>
            <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full w-[10%]" />
            </div>
          </div>
        </div>
      )
    ...
    },
    {
      ...
      visual: (
        <div className="flex -space-x-2 mt-4 justify-start items-center">
          ...
          <div className="h-8 w-8 rounded-full bg-teal-600/30 border border-teal-500/50 flex items-center justify-center text-[10px] font-bold text-indigo-200 ring-2 ring-[#030014]">
            +2k
          </div>
        </div>
      )
  ...
  return (
    <section className="relative py-20 bg-[#030014]/60 border-y border-white/5">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[350px] w-[600px] rounded-full bg-teal-600/5 blur-[100px] pointer-events-none" />
