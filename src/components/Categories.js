  ...
  const categories = [
    ...
    },
    {
      ...
      prompts: [
        ...
        "Write a welcome email for subscribers onboarding to Prompt-Flow Pro.",
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-semibold border transition-all cursor-pointer ${
                  activeCat.id === cat.id
                    ? "bg-teal-600 border-cyan-500 text-white shadow-lg shadow-cyan-500/25"
        ...
        <div className="mt-12 max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl glass-panel border border-white/10">
              <div>
                <span className="text-xs font-semibold text-cyan-400 uppercase tracking-widest">{activeCat.name}</span>
