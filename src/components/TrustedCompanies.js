  ...
  const companies = [
    {
      name: "Stripe",
      logo: (
        <svg className="h-6 text-slate-500 hover:text-teal-400 transition-colors" viewBox="0 0 60 25" fill="currentColor">
    ...
    },
    {
      name: "Slack",
      logo: (
        <div className="flex items-center gap-2 text-slate-500 hover:text-cyan-400 transition-colors cursor-pointer font-bold">
