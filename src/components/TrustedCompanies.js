...
export default function TrustedCompanies() {
  const companies = [
    {
      ...
      logo: (
        <svg
          className="h-6 text-white/30 hover:text-amber-400 transition-colors"
          viewBox="0 0 60 25"
          fill="currentColor"
        >
    ...
    },
    {
      name: "Vercel",
      logo: (
        <div className="flex items-center gap-2 text-white/30 hover:text-white transition-colors cursor-pointer font-bold tracking-wider">
    ...
    },
    {
      name: "HubSpot",
      logo: (
        <div className="flex items-center gap-1 text-white/30 hover:text-amber-400 transition-colors cursor-pointer font-semibold">
          <svg
            className="h-5 w-5"
            viewBox="0 0 24 24"
            fill="none"
    ...
    },
    {
      name: "Framer",
      logo: (
        <div className="flex items-center gap-2 text-white/30 hover:text-rose-400 transition-colors cursor-pointer font-semibold">
    ...
    },
    {
      name: "Figma",
      logo: (
        <div className="flex items-center gap-1 text-white/30 hover:text-indigo-300 transition-colors cursor-pointer font-semibold">
    ...
    },
    {
      name: "Shopify",
      logo: (
        <div className="flex items-center gap-1.5 text-white/30 hover:text-amber-400 transition-colors cursor-pointer font-bold">
    ...
    },
    {
      name: "Slack",
      logo: (
        <div className="flex items-center gap-2 text-white/30 hover:text-rose-300 transition-colors cursor-pointer font-bold">
  ...
  return (
    <section className="relative py-12 border-y border-white/[0.06] bg-[#08060f] overflow-hidden">
      {/* faint scanline grid to tie into the console aesthetic used elsewhere on the page */}
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2">
          ...
          <p className="font-mono text-[11px] font-bold uppercase tracking-[0.2em] text-white/35">
            Trusted by teams shipping with Prompt-Flow
          </p>
          <span className="h-1 w-1 rounded-full bg-amber-400" />
        </div>
        ...
        <div className="mt-8 relative w-full flex items-center overflow-x-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-r from-[#08060f] to-transparent z-10 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-l from-[#08060f] to-transparent z-10 pointer-events-none" />
          ...
          <div className="flex w-max gap-16 items-center animate-marquee no-scrollbar">
            ...
            {companies.map((company, index) => (
              <div
                key={`company-1-${index}`}
                className="flex-shrink-0 flex items-center justify-center min-w-[120px] transition-transform hover:scale-105 duration-300"
              >
                {company.logo}
              </div>
            ))}
