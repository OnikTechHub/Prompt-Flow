...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/5 bg-[#020813]/80 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 border-b border-white/5 pb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-tr from-teal-600 to-cyan-500">
                <Zap className="h-4 w-4 text-white" />
              </div>
              <span className="text-base font-bold text-white">Prompt-Flow</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-slate-500">
              Support email: <br />
              <span className="font-semibold text-slate-300">support@prompt-flow.ai</span>
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-4">
          <p>© {new Date().getFullYear()} Prompt-Flow Inc. All rights reserved.</p>
