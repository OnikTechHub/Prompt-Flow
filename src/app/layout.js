...
export const metadata = {
  title: "Prompt-Flow - Advanced AI Content Generator Platform",
...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-bg-dark text-slate-100 selection:bg-teal-500/30 selection:text-cyan-200">
        <QueryProvider>
          <AuthProvider>
            {children}
            <Toaster 
