...
export default function TemplateDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-slate-100 flex flex-col font-sans relative selection:bg-teal-500/30 selection:text-cyan-200">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 h-[550px] w-full max-w-7xl bg-gradient-to-b from-cyan-500/10 via-transparent to-transparent blur-[120px] pointer-events-none" />
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="h-64 sm:h-80 w-full rounded-3xl overflow-hidden border border-white/10 relative bg-black/40">
              {template.imageUrl ? (
                ...
                <div className="w-full h-full bg-gradient-to-tr from-blue-600/10 via-teal-500/10 to-cyan-600/10 flex items-center justify-center text-cyan-400/80">
                  <Sparkles className="h-16 w-16 animate-pulse" />
                </div>
              )}
              <span className="absolute top-4 right-4 px-3 py-1 rounded bg-black/70 border border-white/10 text-[10px] font-bold text-cyan-400 uppercase tracking-wider shadow-lg">
                {template.category}
              </span>
            </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex flex-wrap gap-2">
                  {template.tags.map((tag, idx) => (
                    <span key={idx} className="flex items-center gap-1 px-3 py-1 rounded-full bg-teal-500/10 border border-cyan-500/20 text-[10px] font-medium text-cyan-300">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="glass-panel border border-white/10 rounded-3xl p-6 space-y-4 shadow-xl">
              ...
              {isAuthenticated ? (
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg text-white text-xs font-bold transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg text-white text-xs font-bold transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-1.5 cursor-pointer"
                >
            ...
            <div className="glass-panel border border-white/10 rounded-3xl p-6 space-y-3.5 shadow-xl">
              ...
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-teal-600 to-cyan-500 flex items-center justify-center text-white font-bold text-sm shadow">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-0.5">{template.createdBy?.email || "community@prompt-flow.ai"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedTemplates.map((rel) => (
                <div 
                  ...
                  className="glass-panel border border-white/10 rounded-2xl p-5 hover:border-cyan-500/30 transition-all duration-300 cursor-pointer flex flex-col justify-between h-full hover:scale-[1.01] group"
                >
                  <div className="space-y-3">
                    ...
                    <h4 className="text-xs font-bold text-white group-hover:text-cyan-300 transition-colors line-clamp-1">{rel.title}</h4>
                    <p className="text-[11px] text-slate-400 line-clamp-2 leading-relaxed">{rel.description}</p>
                  </div>
                  
                  <div className="flex items-center gap-1 text-[10px] font-bold text-cyan-400 group-hover:text-cyan-300 transition-colors pt-4 mt-auto">
