    ...
    <div className="min-h-screen bg-[#030014] text-slate-100 flex flex-col font-sans relative selection:bg-teal-500/30 selection:text-cyan-200">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-28 relative z-10">
        ...
        <div className="space-y-3 mb-10 pb-6 border-b border-white/5 text-center sm:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-500/10 border border-cyan-500/20 text-cyan-400 text-[10px] font-bold uppercase tracking-wider">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {paginatedTemplates.map((template) => (
                <div 
                  key={template._id} 
                  className="glass-panel border border-white/10 rounded-2xl overflow-hidden hover:border-cyan-500/30 transition-all duration-300 flex flex-col h-full hover:scale-[1.01] hover:shadow-xl hover:shadow-purple-950/5 group"
                >
                  ...
                  <div className="relative h-44 w-full overflow-hidden border-b border-white/5 flex-shrink-0 bg-black/40">
                    ...
                    <span className="absolute top-3 right-3 px-2 py-0.5 rounded bg-black/60 border border-white/10 text-[9px] font-bold text-cyan-400 uppercase tracking-wider">
                      {template.category}
                    </span>
                  </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                    <div className="space-y-2">
                      <h3 className="text-sm font-bold text-white group-hover:text-cyan-300 transition-colors line-clamp-1">{template.title}</h3>
            ...
            <div className="pt-4.5 border-t border-white/5 mt-5 flex gap-2 justify-end flex-shrink-0">
              {isAuthenticated && (
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg text-white text-xs font-bold transition-all cursor-pointer"
                >
                  Run in AI Workspace
                </button>
              )}
