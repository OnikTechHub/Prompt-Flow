...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-slate-100 flex flex-col items-center justify-center relative px-4 font-sans selection:bg-teal-500/30 selection:text-cyan-200">
      ...
      <div className="max-w-md w-full text-center space-y-6 relative z-10 animate-fade-in">
        ...
        {/* Error icon circle */}
        <div className="h-16 w-16 rounded-2xl bg-teal-500/10 border border-cyan-500/20 text-cyan-400 flex items-center justify-center mx-auto shadow-lg shadow-cyan-500/5">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            onClick={() => router.push("/")}
            className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg hover:shadow-teal-500/10 text-white text-xs font-bold transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-1.5 cursor-pointer"
          >
