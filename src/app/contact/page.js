            ...
            <div className="glass-panel border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl bg-gradient-to-br from-white/2 to-white/0">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-xl bg-teal-500/10 border border-cyan-500/25 flex items-center justify-center text-cyan-400 flex-shrink-0">
                    <Mail className="h-5 w-5" />
                  </div>
                  <div>
                    <h5 className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Email Address</h5>
                    <a href="mailto:support@prompt-flow.ai" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors mt-0.5 block">
                      support@prompt-flow.ai
                    </a>
                  </div>
                </div>
              ...
              {submitted ? (
                <div className="p-8 text-center space-y-4 animate-fade-in">
                  ...
                  <p className="text-xs text-slate-400 max-w-sm mx-auto leading-relaxed">
                    Thank you for contacting Prompt-Flow. Your message was processed successfully, and our support team will reply within 24 hours.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full mt-1.5 px-3.5 py-2.5 rounded-xl bg-black/40 border focus:outline-none text-xs text-white placeholder-slate-600 transition-colors ${
                          errors.name ? "border-pink-500/50 focus:border-pink-500" : "border-white/5 focus:border-cyan-500/50"
                        }`}
                      />
                      {errors.name && (
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full mt-1.5 px-3.5 py-2.5 rounded-xl bg-black/40 border focus:outline-none text-xs text-white placeholder-slate-600 transition-colors ${
                          errors.email ? "border-pink-500/50 focus:border-pink-500" : "border-white/5 focus:border-cyan-500/50"
                        }`}
                      />
                      {errors.email && (
                        <span className="flex items-center gap-1 text-[10px] text-pink-400 mt-1 font-semibold animate-pulse-slow">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full mt-1.5 px-3.5 py-2.5 rounded-xl bg-black/40 border focus:outline-none text-xs text-white placeholder-slate-600 transition-colors ${
                        errors.subject ? "border-pink-500/50 focus:border-pink-500" : "border-white/5 focus:border-cyan-500/50"
                      }`}
                    />
                    {errors.subject && (
                      <span className="flex items-center gap-1 text-[10px] text-pink-400 mt-1 font-semibold animate-pulse-slow">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className={`w-full mt-1.5 p-3.5 rounded-xl bg-black/40 border focus:outline-none text-xs text-white placeholder-slate-600 transition-colors resize-none ${
                        errors.message ? "border-pink-500/50 focus:border-pink-500" : "border-white/5 focus:border-cyan-500/50"
                      }`}
                    />
                    {errors.message && (
                      <span className="flex items-center gap-1 text-[10px] text-pink-400 mt-1 font-semibold animate-pulse-slow">
