  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data && res.data.success) {
        ...
        localStorage.setItem("prompt-flow_jwt", userData.token);
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-slate-100 flex flex-col items-center justify-center relative px-4 py-12">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel rounded-2xl p-6 sm:p-8 border border-white/10 shadow-2xl shadow-cyan-950/15">
