      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-28 relative z-10">
        ...
        <div className="space-y-4 text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base text-slate-400 leading-relaxed">
            Prompt-Flow is a unified prompt management catalog built to help developers, creators, and teams construct, share, and debug production-grade LLM prompt templates.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-20">
          <div className="lg:col-span-7 space-y-5">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Prompt-Flow was born to solve this. We built a central repository that bridges the gap between raw natural language instructions and repeatable, database-driven templates. Today, we empower thousands of builders to design, validate, and invoke prompt templates dynamically.
            </p>
          </div>
          
          <div className="lg:col-span-5">
            <div className="glass-panel border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6 bg-gradient-to-tr from-cyan-950/10 to-indigo-900/10 shadow-2xl relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/5 to-cyan-500/5 pointer-events-none" />
              
              <div className="space-y-1 text-center sm:text-left">
                <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-400">10k+</span>
                <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Active Prompt Builders</p>
              </div>
              <div className="h-px bg-white/5" />
              <div className="space-y-1 text-center sm:text-left">
                <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-400">500k+</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
          {/* Mission Card */}
          <div className="glass-panel border border-white/10 rounded-3xl p-6 sm:p-8 space-y-4 hover:border-cyan-500/30 transition-all duration-300">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-blue-600/20 to-teal-600/20 border border-blue-500/30 flex items-center justify-center text-blue-400">
          ...
          {/* Vision Card */}
          <div className="glass-panel border border-white/10 rounded-3xl p-6 sm:p-8 space-y-4 hover:border-cyan-500/30 transition-all duration-300">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-cyan-600/20 to-pink-600/20 border border-cyan-500/30 flex items-center justify-center text-cyan-400">
