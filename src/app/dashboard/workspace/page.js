        ...
        <div className="flex items-center justify-between md:hidden bg-white/2 border border-white/5 p-4 rounded-2xl mb-6 flex-shrink-0">
          <div className="flex items-center gap-2">
            {user.profilePhoto || user.avatar ? (
              ...
              <div className="h-8 w-8 rounded-lg bg-gradient-to-tr from-teal-600 to-cyan-500 flex items-center justify-center text-white text-xs font-bold">
                ...
                <form onSubmit={handleGenerate} className="lg:col-span-5 space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full mt-1 px-3 py-2.5 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors disabled:opacity-50"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      disabled={isGenerating}
                      className="w-full mt-1 px-3 py-2.5 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-slate-300 transition-colors disabled:opacity-50 cursor-pointer"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg hover:shadow-cyan-500/20 text-white text-xs font-bold transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-40 flex items-center justify-center gap-2 cursor-pointer"
                  >
                    {isGenerating ? (
                      <>
                    ...
                    <div className="min-h-[300px] p-5 rounded-2xl bg-black/60 border border-white/5 font-mono text-xs leading-relaxed text-slate-300 relative overflow-hidden select-text shadow-inner">
                      ...
                      {isGenerating && generationProgress < 100 && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/75 backdrop-blur-[1px] space-y-3">
                          <span className="text-[10px] font-bold text-cyan-400 tracking-wider uppercase animate-pulse">Running Gemini content pipeline...</span>
