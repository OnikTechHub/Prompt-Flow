                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="relative max-w-xs w-full sm:w-64">
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors"
                    />
                      ...
                      >
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between text-[10px]">
                            <span className="px-2 py-0.5 rounded-full bg-teal-500/10 border border-cyan-500/20 text-cyan-400 font-bold uppercase tracking-wider">
              ...
              {filteredHistory.length > itemsPerPage && (
                <div className="flex items-center justify-between pt-8 border-t border-white/5 mt-8">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-white px-3 py-1 rounded-lg bg-teal-500/10 border border-cyan-500/20">
