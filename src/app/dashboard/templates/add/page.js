  ...
  return (
    <div className="min-h-screen bg-[#030014] text-slate-100 flex flex-col font-sans relative selection:bg-teal-500/30 selection:text-cyan-200">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-28 relative z-10">
        ...
        {/* Branded Form panel */}
        <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-white/10 shadow-2xl shadow-cyan-950/15">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="mt-1.5 relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors disabled:opacity-50"
                  />
            ...
            <div>
              ...
              <textarea
                ...
                disabled={mutation.isPending}
                className="w-full mt-1.5 p-4 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors font-mono resize-none disabled:opacity-50"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={mutation.isPending}
              className="w-full mt-2 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg hover:shadow-cyan-500/25 text-white text-xs font-bold transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 flex items-center justify-center gap-1.5 cursor-pointer"
            >
              {mutation.isPending ? (
                <>
