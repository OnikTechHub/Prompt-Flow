      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-28 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 pb-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-teal-600 to-cyan-500 flex items-center justify-center text-white shadow shadow-cyan-500/25">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-4.5 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 hover:shadow-lg hover:shadow-cyan-500/25 text-white text-xs font-bold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
          <div className="relative max-w-md w-full">
            <input
              ...
              className="w-full bg-white/5 border border-white/5 focus:border-cyan-500/50 focus:outline-none rounded-xl pl-10 pr-4 py-3 text-xs text-white placeholder-slate-500 transition-colors"
            />
        ...
        {fetchingTemplates ? (
                    ...
                    <tr key={template._id} className="hover:bg-white/2 transition-colors">
                      <td className="px-6 py-4 flex items-center gap-3.5 max-w-sm">
                        {template.imageUrl ? (
                          ...
                          <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-blue-600/20 to-cyan-600/20 border border-white/10 flex items-center justify-center text-cyan-400">
                ...
                <div key={template._id} className="glass-panel border border-white/10 rounded-2xl p-5 space-y-4">
                  <div className="flex items-center gap-3">
                    {template.imageUrl ? (
                      ...
                      <div className="h-12 w-12 rounded-xl bg-gradient-to-tr from-blue-600/20 to-cyan-600/20 border border-white/10 flex items-center justify-center text-cyan-400">
                    ...
                    <div className="truncate">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="px-1.5 py-0.5 rounded bg-white/5 border border-white/5 text-[8px] font-bold text-cyan-400 uppercase tracking-wider">
                          {template.category}
                        </span>
          ...
          <div className="p-16 text-center border border-dashed border-white/10 rounded-3xl space-y-4 bg-black/25">
            ...
            {(!searchQuery && categoryFilter === "All") && (
              <button
                onClick={() => router.push("/dashboard/templates/add")}
                className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 text-white text-xs font-bold hover:shadow-lg cursor-pointer"
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {viewTemplate.tags.map((tag, idx) => (
                      <span key={idx} className="px-2 py-0.5 rounded bg-teal-500/10 border border-cyan-500/20 text-[9px] font-medium text-cyan-300">
                        {tag}
                      </span>
                    ))}
                  </div>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4 overflow-y-auto pr-1 flex-1 custom-scrollbar">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative mt-1">
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors"
                    />
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full mt-1 p-3 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors font-mono resize-none"
                />
              </div>
              ...
              <div className="pt-4 border-t border-white/5 flex gap-3 justify-end flex-shrink-0">
                ...
                <button
                  type="submit"
                  disabled={editMutation.isPending}
                  className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 text-white text-xs font-bold hover:shadow-lg disabled:opacity-40 cursor-pointer"
                >
