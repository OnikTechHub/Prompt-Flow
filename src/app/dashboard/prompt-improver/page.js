                ...
                <form onSubmit={handleImprove} className="lg:col-span-5 space-y-4">
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full mt-1.5 p-3.5 rounded-xl bg-black/40 border border-white/5 focus:border-cyan-500/50 focus:outline-none text-xs text-white placeholder-slate-600 transition-colors resize-none disabled:opacity-50"
                    />
                  </div>
                    ...
                    <div className="min-h-[350px] p-5 rounded-2xl bg-black/60 border border-white/5 relative overflow-hidden select-text shadow-inner">
                      ...
                      {isImproving && improverProgress < 100 && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/75 backdrop-blur-[1px] space-y-3">
                          <span className="text-[10px] font-bold text-cyan-400 tracking-wider uppercase animate-pulse">Running engineering pipeline...</span>
                      ...
                      {improvedData ? (
                        <div className="space-y-5 animate-fade-in text-xs">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="bg-[#0c0824]/50 border border-cyan-500/20 p-3.5 rounded-xl text-slate-200 font-mono leading-relaxed relative">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                            ...
                            <div className="space-y-1 bg-white/2 p-3 rounded-xl border border-white/5">
                              <h5 className="text-[9px] uppercase font-bold text-teal-400 flex items-center gap-1">
